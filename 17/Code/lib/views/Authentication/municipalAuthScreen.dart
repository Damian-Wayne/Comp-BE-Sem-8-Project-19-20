...
class MunicipalSignup extends StatefulWidget {
  final AuthFormType authFormType;

  MunicipalSignup({Key key, @required this.authFormType}) : super(key: key);

  @override
  _MunicipalSignupState createState() =>
      _MunicipalSignupState(authFormType: this.authFormType);
}

class _MunicipalSignupState extends State<MunicipalSignup> {
  AuthFormType authFormType;
  _MunicipalSignupState({this.authFormType});
  final formKey = GlobalKey<FormState>();
  String _email;
  String _password;
  String _name;
  String _error;
  String role = "Municipal";
